            ...
            <footer className="footer footer-center p-10 bg-base-200 text-base-content rounded">
                ...
                <nav>
                    ...
                    <div className="grid grid-flow-col gap-10">
                        <a href='https://github.com/BKHChathuranga' target='_blank'><svg
                        ...
                        <a href='https://medium.com/@chathurangabkh' target='_blank'><svg
                            viewBox="0 0 640 512"
                            fill="currentColor"
                            height="30"
                            width="30"
                        ...
                        <a href='https://linkedin.com/in/hashan-chathuranga' target='_blank'><svg
                            viewBox="0 0 1024 1024"
                            fill="currentColor"
                            height="30"
                            width="30"
                    ...
                    <p className='text-white opacity-40'>Find me on</p>
                </nav>
                <aside>
                    <p>Made by Hashan Chathuranga</p>
                </aside>
            </footer>
        </div>
    )
