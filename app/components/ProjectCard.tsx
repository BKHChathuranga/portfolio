...
const ProjectCard: FC<Props> = (props: Props) => {
    return (
        <div className="group flex md:flex-row flex-col card card-side bg-base-100 shadow-xl transition ease-in-out delay-150 bg-gradient-to-r from-[#1d262b] via-[#2a3338] to-[#41494e] hover:scale-105 hover:bg-[#0e161b] duration-300 sm:w-[80%] border-s-2 border-gray-600">
            ...
            <div className="basis-3/4 card-body flex flex-col px-4 pb-4 pt-0 sm:p-8">
                ...
                <div className="flex sm:flex-row card-actions sm:justify-end flex-wrap">
